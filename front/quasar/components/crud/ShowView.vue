...
export default {
  ...
  computed: {
    ...
    columns() { return this.$store.getters['crud/getShowColumn'](this.crudkey) },
    item() { return this.$store.getters['bovin/list/items']}
  },
  methods: {},
  created() {
    this.$store.dispatch('crud/FetchCrudConfig', this.crudkey)
  }
}
</script>
