...
class UrlAutoCompleteFilterType extends AbstractFilterType
{
    ...
    public function init($columnName, $label = null, $alias = 'entity')
    {
        ...
        $this->data_keys = ['op', 'value', 'value_label'];
    }
    ...
    {
        return '@LleCrudit/filter/state/url_auto_complete_filter.html.twig';
    }

    public function getTemplate()
    {
        return '@LleCrudit/filter/type/url_auto_complete_filter.html.twig';
    }
}
