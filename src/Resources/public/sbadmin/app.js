...
window.addEventListener('load', function () {
  ...
  var ids = []; // Check or uncheck all checkboxes

  batchCheckAll.addEventListener('change', function (event) {
  ...
  hideBatchForms(); // Display the form if batch action contains one

  dropdownItems.forEach(function (dropdownItem) {
    dropdownItem.addEventListener('click', function () {
      if (dropdownItem.dataset.form) {
        document.querySelectorAll('.batch_action_form').forEach(function (form) {
          hideBatchForms();
...
function saveCheckedId(target, ids, checkbox) {
  if (target.checked) {
    ...
    var index = ids.indexOf(checkbox.dataset.id);
