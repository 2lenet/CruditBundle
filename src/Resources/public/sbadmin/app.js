...
window.addEventListener('load', function () {
  ...
  var ids = []; // Check/uncheck all checkboxes
  // Show batch list if all checkboxes are checked

  if (batchCheckAll) {
    batchCheckAll.addEventListener('change', function () {
  ...
  dropdownItems.forEach(function (dropdownItem) {
    dropdownItem.addEventListener('click', function (event) {
      if (dropdownItem.dataset.form) {
        var form = document.getElementById(dropdownItem.dataset.form);
...
function countChecked() {
  var batchCheckAll = document.getElementById('crudit-batch-check-all');
  var checkboxes = document.querySelectorAll('.crudit-batch-check');
  var checked = 0; // Count how many checkboxes are checked
  ...
  batchCheckAll.checked = checked == checkboxes.length; // Show batch list if at least 1 checkbox is checked
...
function showBatchList(showBatchList) {
  var batchList = document.querySelector('.crudit-batch-list'); // Hide all forms
...
function hideForms() {
  var forms = document.querySelectorAll('.batch-action-form');
...
window.addEventListener('DOMContentLoaded', function () {
  document.querySelectorAll(".crudit-eip-input[type='checkbox']").forEach(function (eip_checkbox) {
...
window.addEventListener('load', function () {
  document.querySelectorAll(".crudit-eip").forEach(function (eip_elem) {
    ...
    var eip_form = eip_elem.querySelector("form"); //if input type is checkbox retrieve initial disabled value
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var filtersContainer = document.getElementById('collapse-filter');
...
/* harmony import */ var _editinplace__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./editinplace */ "./assets/sb-admin/js/editinplace.js");
/* harmony import */ var _editinplace__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_editinplace__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _batch_actions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./batch_actions */ "./assets/sb-admin/js/batch_actions.js");
/* harmony import */ var _batch_actions__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_batch_actions__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _input_format__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./input_format */ "./assets/sb-admin/js/input_format.js");
/* harmony import */ var _input_format__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_input_format__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _filters__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./filters */ "./assets/sb-admin/js/filters.js");
/* harmony import */ var _form__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./form */ "./assets/sb-admin/js/form.js");
